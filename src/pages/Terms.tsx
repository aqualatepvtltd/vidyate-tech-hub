...
const Terms: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-20 animate-subtle-fade">
      ...
      />
      <Link to="/" className="inline-flex items-center gap-2 text-theme-muted hover:text-black dark:hover:text-white transition-all font-black text-[10px] uppercase tracking-widest mb-8">
      ...
      <div className="glass p-8 md:p-12 rounded-2xl border" style={{ borderColor: 'var(--glass-border)' }}>
        ...
        <div className="prose prose-sm md:prose-base prose-invert max-w-none mt-6 space-y-6 text-xs md:text-sm font-medium opacity-85 leading-relaxed" style={{ color: 'var(--text-main)' }}>
          <section className="space-y-2">
            <h2 className="text-base font-black text-black dark:text-white underline decoration-1">1. Acceptance of Terms</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-black text-black dark:text-white underline decoration-1">2. Use of Academic Resources</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-black text-black dark:text-white underline decoration-1">3. Disclaimer of Professional Engineering Advice</h2>
            <div className="p-4 rounded-xl border border-neutral-500/30 bg-neutral-500/5 text-neutral-800 dark:text-neutral-200 text-xs">
          ...
          <section className="space-y-2">
            <h2 className="text-base font-black text-black dark:text-white underline decoration-1">4. Textbook Store & Logistics</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-black text-black dark:text-white underline decoration-1">5. Certification Proctoring Consent</h2>
            <p>
          ...
          <section className="space-y-2 pt-4 border-t border-neutral-200 dark:border-neutral-800">
            <h2 className="text-base font-black text-black dark:text-white underline decoration-1">6. Contact Us</h2>
