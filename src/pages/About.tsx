...
const About: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-10">
      <SEO 
        title="About Vidyate Tech Hub | Revolutionizing Engineering Education" 
        description="Discover Vidyate Tech Hub's mission to transform computer science, electronics, and mechanical engineering education through digital accessibility, expert-curated modules, and resource minimalism."
        keywords="About Vidyate, Engineering Education India, Digital Computer Science learning, DSA cheat sheets, VLSI design guides, Mechanical syllabus"
      />
      
      {/* Hero Section */}
      <section className="py-16 md:py-24 text-center relative overflow-hidden animate-subtle-fade">
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-0 left-1/4 w-64 h-64 bg-neutral-500/5 rounded-full blur-[100px] animate-pulse"></div>
          <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-neutral-400/5 rounded-full blur-[100px] animate-pulse delay-500"></div>
        </div>
        
       
        <h1 className="text-4xl md:text-7xl font-black mb-6 leading-[1.15] tracking-tighter" style={{ color: 'var(--text-main)' }}>
          Dedicated to <br/>
          <span>Technical</span> Mastery.
        </h1>
        <p className="opacity-60 text-sm md:text-lg max-w-2xl mx-auto leading-relaxed font-medium mb-12" style={{ color: 'var(--text-main)' }}>
          Vidyate Tech Hub is India's premier, streamlined digital ecosystem designed to make complex coding structures, silicon microchips, and thermodynamics equations easy to conquer.
        </p>
      </section>
      ...
      <section className="py-16 md:py-24 animate-subtle-fade">
        ...
        >
          <div className="lg:col-span-3">
            ...
            <h2 className="text-3xl md:text-4xl font-black mb-6 tracking-tighter" style={{ color: 'var(--text-main)' }}>Minimal Noise, Practical Knowledge.</h2>
            <div className="space-y-4 opacity-70 leading-relaxed font-medium text-xs md:text-sm" style={{ color: 'var(--text-main)' }}>
              <p>
                The modern engineering curriculum is dense with vast programming models, system architectures, physical semiconductor principles, and intricate mathematical equations. Too often, students waste vital preparation hours searching disjointed directories.
              </p>
              <p>
                We apply a strict rule of <strong>Resource Minimalism</strong>. We strip away wordy descriptions, isolating clean codebase implementations, verified circuit schematics, and high-yield formula checksheets aligned directly with leading university and GATE standards.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24">
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          {[
            ...
            { title: 'Clean Digital Delivery', desc: 'Study notes are compiled, designed in high-contrast layouts, and linked directly to lightning-fast cloud systems.', icon: 'picture_as_pdf' }
          ].map((item, i) => (
      ...
      <section className="py-16 md:pb-24">
        <div className="glass p-8 md:p-16 rounded-3xl border text-center relative overflow-hidden shadow-2xl bg-gradient-to-br from-neutral-500/5 to-transparent">
          <h2 className="text-3xl md:text-5xl font-black mb-6 leading-tight tracking-tighter" style={{ color: 'var(--text-main)' }}>
            Your Competitive <br/> Academic <span className="underline decoration-2">Edge</span>.
          </h2>
          <p className="opacity-60 text-xs md:text-base font-medium mb-10 max-w-xl mx-auto" style={{ color: 'var(--text-main)' }}>
            Stop searching countless disjointed groups. Explore India's premium engineering academic hub that thousands of students trust.
          </p>
          <Link 
            to="/"
